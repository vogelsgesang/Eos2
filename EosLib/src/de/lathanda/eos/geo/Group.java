...
/**
 * Gruppen sind Kontainer für Figuren.
 * Diese erlauben es mehrere Figuren gemeinsam zu verändern.
 * Jede Gruppe verwaltet ihr eigenes relatives Koordinatensystem.
 * Deshalb verhalten sich alle Aufrufe an eine Figur innerhalb einer Gruppe
 * relativ zum Gruppen Koordinatensystem.
 * 
 *
...
public class Group extends Figure implements FigureGroup  {
    ...
    /**
     * defines the middle of the group.
     * This will implicitly deactivate automatic centering.
     * To reactivate it, call centerBalancePoint or a similar method.
     * @param x
     * @param y 
     */
